...
import burgerone from '../images/menu16.jpg';
import burgertwo from '../images/menu17.jpg';
import burgerthree from '../images/menu18.jpg';
...
const MenuBurger = () => {
  const pasta = [
    ...
    {
      name: "Single BBQ Chicken Burger",
    ...
    {
      name: "The Double Barrel Meat Feast",
