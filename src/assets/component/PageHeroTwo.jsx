 ...
 import page07 from '../images/page07.png'
...
import CountUp from "react-countup";
 ...
 const PageHeroTwo = () => {
   ...
   return (
     <>
       <div className='h-screen  flex flex-col lg:flex-row items-center justify-around mt-16 p-16'>
         {/* Left Image - Full height on mobile, half on desktop */}
     
         
         {/* Right Content - Full width on mobile, fixed width on desktop */}
         <div className="right mt-25 w-full lg:w-1/2 p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20">
           <h1 className='text-4xl sm:text-4xl md:text-5xl font-medium mb-2'>Who We Are</h1>
           <p className='text-gray-500 text-md sm:text-base mb-4'>Welcome to Koad</p>
